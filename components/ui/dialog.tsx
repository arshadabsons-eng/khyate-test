...
// A full-screen takeover panel (vs. the small centred modal above) — for editors that
// need real room (e.g. Record measurements) so they never need their own scrollbar.
const DialogFullContent = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-0 z-50 flex flex-col bg-background outline-none duration-300",
...
DialogFullContent.displayName = "DialogFullContent";
